...
export const styles = {
    ...
    inputField: "w-full bg-[#3a2b2b]/50 border border-amber-500/20 rounded-xl px-4 py-3 sm:px-5 sm:py-4 focus:outline-none focus:border-amber-400 text-amber-100 placeholder-amber-400/50",
    inputLabel: "block text-amber-300 text-sm font-medium mb-2",
    gridTwoCols: "grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6",
    relativeInput: "relative",
    currencyIcon: "absolute left-4 top-1/2 -translate-y-1/2 text-amber-500 text-lg sm:text-xl",
    ...
    priceLRD: "text-amber-300 font-medium flex items-center gap-1",
    priceUSD: "text-amber-400/70 text-xs flex items-center gap-1 mt-0.5",
...
// Payment method label and classes - Liberia payment methods
export const paymentMethodDetails = {
    ...
    pickup: {
        ...
        icon: 'FiMapPin',
        description: 'Pay when you pick up order'
    },
    mtn_money: {
