        ...
        <div className='min-h-screen bg-gradient-to-r from-orange-900 via-amber-900 to-gray-900 animate-gradient-x py-12 sm:py-16 md:py-20 px-4 sm:px-6 lg:px-8 font-[Poppins] relative overflow-hidden'>
            ...
            <div className='max-w-7xl mx-auto relative z-10'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
                    ...
                    <div className='space-y-6'>
                        ...
                        <div className='relative bg-white/5 backdrop-blur-lg rounded-2xl p-6 shadow-2xl transform transition-all duration-300 hover:scale-[1.02] animate-card-float border-l-4 border-amber-500 hover:border-amber-400 group'>
                            ...
                            <div className='flex items-center mb-4 relative z-10'>
                                ...
                                <h3 className='ml-4 text-amber-100 text-xl font-semibold'>Our Location</h3>
                            </div>
                            <div className='pl-12 relative z-10'>
                                <p className='text-amber-100 font-light text-lg'>SKD Boulevard, Paynesville, Monrovia, Liberia</p>
                            </div>
                        </div>
                    ...
                    {/* Contact Form */}
                    <div className='relative bg-white/5 backdrop-blur-lg rounded-2xl p-6 shadow-2xl animate-slide-in-right border-2 border-amber-500/30 hover:border-amber-500/50 transition-all duration-300'>
                        ...
                        <form onSubmit={handleSubmit} className='space-y-6 relative z-10'>
                                    ...
                                    <div key={field.name}>
                                        ...
                                        <div className='relative'>
                                            <div className='absolute left-3 top-1/2 transform -translate-y-1/2'>
                                                {IconComponent && <IconComponent className='text-amber-500 text-xl animate-pulse' />}
                                            </div>
                                            <input
                                                type={field.type}
                            ...
                            <button
                                type='submit'
                                disabled={isSending}
                                className='w-full bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-700 hover:to-orange-700 text-white font-semibold py-3 px-3 rounded-xl transition-all duration-300 transform hover:scale-[1.02] shadow-lg hover:shadow-amber-500/20 flex items-center justify-center space-x-2 group disabled:opacity-50 disabled:cursor-not-allowed'
                            >
