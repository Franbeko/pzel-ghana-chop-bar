...
const Banner = () => {
    ...
    return (
        <div className='relative'>
            <div className='bg-gradient-to-br from-amber-900 via-amber-800 to-amber-700 text-white py-16 px-4 sm:px-8 relative 
            overflow-hidden'>
                ...
                <div className='max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12 relative z-10'>
                    ...
                    <div className='flex-1 space-y-8 relative md:pr-8 lg:pr-16 text-center md:text-left'>
                        ...
                        <form onSubmit={handleSearch} className='relative max-w-2xl mx-auto md:mx-0 group'>
                            <div className='relative flex items-center bg-amber-900/30 rounded-xl border-2 border-amber-500/30 
                            shadow-2xl hover:bg-amber-900/40 transition-all duration-300'>
                                ...
                                <input 
                                    ...
                                    placeholder='Discover your favorite food or drink...'
                                    className='w-full py-4 pr-6 bg-transparent outline-none placeholder-amber-200/70 text-lg 
                                    font-medium tracking-wide' 
                                />
                                <button 
                                    type='submit' 
                                    className='mr-4 px-6 py-3 bg-gradient-to-r from-amber-400 to-amber-300 rounded-lg font-semibold 
                                    text-amber-900 hover:from-amber-300 hover:to-amber-200 transition-all duration-300 shadow-lg 
                        ...
                        <div className='flex flex-wrap gap-4 justify-center md:justify-start mt-6'>
                            {/* Download App and Watch Video buttons are commented out */}
                        </div>
                    </div>
                    ...
                    <div className='flex-1 relative group mt-8 md:mt-0 min-h-[300px] sm:min-h-[400px]'>
                        ...
                        shadow-2xl z-20 w-[250px] xs:w-[300px] sm:w-[350px] h-[250px] xs:h-[300px] sm:h-[350px] mx-auto'>
                            <img src={bannerImage} alt="P-Zel Ghana Cuisine" className='rounded-full border-4 xs:border-8 
                            border-amber-900/50 w-full h-full object-cover object-center' />
                            <div className='absolute inset-0 rounded-full bg-gradient-to-b from-transparent to-amber-900/40 
                            mix-blend-multiply' />
                        </div>

                        {/* Orbital Images */}
                        {orbitImages && orbitImages.map((ImgSrc, index) => (
                            <div 
                                key={index} 
                            ...
                            >
                                <img 
                                    ...
                                    className='w-full h-full rounded-full border-2 border-amber-500/30 shadow-lg bg-amber-900/20 p-1 
                                    object-cover'
                                />
                            </div>
                        ))}
            ...
            {/* Video Modal */}
            {showVideo && (
                <div className='fixed inset-0 flex items-center justify-center z-50 bg-black/80 backdrop-blur-lg p-4'>
                    <button 
