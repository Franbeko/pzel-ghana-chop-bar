...
const Navbar = () => {
    ...
    // Combine Updating Login Modal and Auth State On Location Change
    ...
    const renderDesktopAuthButton = () => {
        return isAuthenticated ? (
            <button onClick={handleLogout} className='px-3 lg:px-4 py-1.5 lg:py-2 bg-gradient-to-br from-amber-600 to-amber-700 
            text-[#2D1B0E] rounded-2xl font-bold hover:shadow-lg hover:shadow-amber-600/40 transition-all transform hover:scale-[1.02] 
            ...
            <button onClick={() => setShowLoginModal(true)} className='px-3 lg:px-4 py-1.5 lg:py-2 bg-gradient-to-br from-amber-600 to-amber-700 
            text-[#2D1B0E] rounded-2xl font-bold hover:shadow-lg hover:shadow-amber-600/40 transition-all transform hover:scale-[1.02] 
            border-2 border-amber-600/20 flex items-center space-x-2 shadow-md shadow-amber-900/20 text-sm'>
                <FiLogIn className='text-base lg:text-lg' />
                <span className='text-shadow'>
                    Login
                </span>
            </button>
            ...
            <div className="max-w-7xl mx-auto px-4 relative">
                <div className="flex justify-between items-center h-16 lg:h-20">
                    ...
                    <div className="flex-shrink-0 flex items-center space-x-2 group">
                        <MdRestaurant className="text-2xl md:text-3xl lg:text-4xl text-amber-500 transition-all group-hover:rotate-12" />
