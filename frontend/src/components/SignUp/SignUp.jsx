...
const AwesomeToast = ({ message, icon }) => {
  return (
    <div className='animate-slide-in fixed bottom-6 right-6 flex items-center bg-gradient-to-br from-amber-500 to-amber-600 text-white px-6 py-4 rounded-lg shadow-lg border-2 border-amber-300/20 z-50'>
...
const SignUp = () => {
  ...
  return (
    <div className='min-h-screen flex items-center justify-center bg-gradient-to-br from-[#1a1206] to-[#2D1B0E] p-4'>
